...
namespace WebDemoDotNet
{
    ...
    public class RemoteWebDriverTest
    {
        ...
        public RemoteWebDriverExtended PerfectoOpenConnection(DesiredCapabilities capabilities)
        {
            ...
            capabilities.SetCapability("user", "mitchellw@perfectomobile.com");
            capabilities.SetCapability("password", "Spike123!");
        ...
        private static DesiredCapabilities SetWebCapabilities(string browserName, string version,
        ...
        private static DesiredCapabilities SetMobileCapabilies(string platformName, string browserName = "MobileOS", string description = ".*")
        {
            var capabilities = new DesiredCapabilities();
            capabilities.SetCapability("browserName", browserName);
            capabilities.SetCapability("platformName", platformName);
        ...
        {
            SearchWithGoogle(SetMobileCapabilies("iOS", "Safari"));
        }
        [TestMethod]
        public void AndroidChromeTest()
        {
            SearchWithGoogle(SetMobileCapabilies("Android", "Chrome"));
        }
    }
}
